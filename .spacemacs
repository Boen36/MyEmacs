...
(custom-set-faces
 ...
 '(mode-line ((t (:background "#2c2525" :foreground "#F8F8F0" :box (:line-width 0 :color "#2c2525" :style unspecified)))))
 '(mode-line-inactive ((t (:background "#2c2525" :foreground "#75715E" :box (:line-width 0 :color "#2c2525" :style unspecified))))))
)
